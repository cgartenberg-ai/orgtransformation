...
Batch 10: bloomberg (14), lockheed-martin (14), mercedes-benz (16), pepsico (12) = 56 new claims.
"""
...
# Files to merge
MERGE_FILES = [
    {"file": "bloomberg.json", "specimenId": "bloomberg"},
    {"file": "lockheed-martin.json", "specimenId": "lockheed-martin"},
    {"file": "mercedes-benz.json", "specimenId": "mercedes-benz"},
    {"file": "pepsico.json", "specimenId": "pepsico"},
]
