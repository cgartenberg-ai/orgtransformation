import type { DesignPrinciple } from '../types/library';
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-2">
        <h3 className="font-semibold text-gray-900 pr-2">{principle.title}</h3>
        <button
          onClick={(e) => {
            e.stopPropagation();
            onToggleStar();
      ...
      <p className="text-sm text-gray-600 mb-3 line-clamp-3">{principle.insight}</p>
